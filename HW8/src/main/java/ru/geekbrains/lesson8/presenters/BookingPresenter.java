...
public class BookingPresenter implements ViewObserver {
    ...
    public void updateUIShowChangeReservationTableResutl(int oldReservationNo, int resevationNo){
        view.showChangeReservationTableResult(oldReservationNo, resevationNo);
    }
    ...
    public void changeReservationTable(int oldReservation, Date reservationDate, int tableNo, String name) {
        try {
            ...
            updateUIShowChangeReservationTableResutl(oldReservation, reservationNo);
        }
        catch (RuntimeException e){
            updateUIShowReservationTableResult(-1);
        }
