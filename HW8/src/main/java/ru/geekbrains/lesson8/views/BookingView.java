...
public class BookingView implements View {
    ...
    @Override
    public void showChangeReservationTableResult(int oldReservationNo, int reservationNo) {
        if (reservationNo > 0){
            System.out.printf("Бронь #%d отменена. Новая бронь: #%d\n", oldReservationNo, reservationNo);
        }
        else {
            System.out.printf("Не удалось изменить бронь #%d. Такой брони не существует.", oldReservationNo);
        }
    }
